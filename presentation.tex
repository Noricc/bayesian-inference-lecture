...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/posterior_ratio_prediction.pdf}
\end{figure}
\end{frame}
...
\begin{frame}
  \begin{align*}
    ...
    \mu_j &= \parameter{\alpha}[\observed{M_j}] + \parameter{\beta}[\observed{W_j}] + \markmath{arrayaccess}{\parameter{\gamma}[\observed{T_j}]}\\
    \markmath{alpha}{\parameter{\alpha_i}} &\sim \normal{0.0, 0.5}\\
    \markmath{beta}{\parameter{\beta_i}} &\sim \normal{0.0, 0.2}\\
    \markmath{gamma}{\parameter{\gamma_i}} &\sim \normal{0.0, 0.2}\\
...
\begin{frame}
  \begin{align*}
    \log(\observed{ET_j}) &\sim \text{Normal}(\mu_j, \parameter{\sigma})\\
    \mu_j &= \parameter{\alpha}[\observed{M_j}] + \parameter{\beta}[\observed{W_j}] + \parameter{\gamma^{M}}[\observed{M_j}, \observed{T_j}] + \parameter{\gamma^{W}}[\observed{W_j}, \observed{T_j}]\\
    \markmath{alpha}{\parameter{\alpha_i}} &\sim \normal{0.0, 0.5}\\
    \markmath{beta}{\parameter{\beta_i}} &\sim \normal{0.0, 0.2}\\
